...
model.add(LSTM(128, return_sequences=True))  # Change return_sequences to True for sequence output
model.add(TimeDistributed(Dense(num_classes, activation='softmax')))  # Sigmoid for multi-label output
